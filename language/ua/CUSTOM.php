...
// Premium
$LNG['prem1']				    	= 'Окончание премиум аккаунта';
$LNG['prem2']				    	= "Премиум аккаунт";
$LNG['prem3']				    	= 'Бонусы премиум аккаунта';
$LNG['prem4']				    	= "Скорость добычи ресурсов";
$LNG['prem5']				    	= 'Увеличивает скорость добычи рудников';
$LNG['prem6']				    	= "Внимание!!! Не увеличивает добычу коллайдера!";
$LNG['prem7']				    	= 'Вместимость хранилища';
$LNG['prem8']				    	= "Увеличивает вместительность хранилищ на планетах и лунах";
$LNG['prem9']				    	= 'не увеличивает вместительность флотов';
$LNG['prem10']				    	= "Скорость строительства и исследования";
$LNG['prem11']				    	= 'Увеличивает скорость строительства построек и скорость исследования';
$LNG['prem12']				    	= "Очередь строительства и исследования";
$LNG['prem13']				   	 	= 'Дает возможность добавлять больше исследований и построек в очередь';
$LNG['prem14']				    	= "Кнопка Бонус";
$LNG['prem15']				    	= 'Увеличивает размер получемого бонуса';
$LNG['prem16']				    	= "Бонус 'Экспедиция'";
$LNG['prem17']				    	= 'Увеличивает количество ресурсов, привели флотов и экспедиция';
$LNG['prem18']				    	= "Влияет на шанс удачного экспедиции'";
$LNG['prem19']				    	= 'Количество экспедиций';
$LNG['prem20']				    	= "Увеличивает максимальное количество одновременных экспедиций'";
$LNG['prem21']				    	= 'Защита Луны';
$LNG['prem22']				    	= "Снижает шансы уничтожить вашу луну";
$LNG['prem23']				        = 'Количественный зарабатывать опыт';
$LNG['prem24']				    	= "Увеличивает скорость уровне накопления и увеличивает количество очков, заработанных за борьбу Альянс. ";
$LNG['prem25']				    	= "Альянс Банк ";
$LNG['prem26']				    	= "Увеличивает максимальное количество ресурсов передачи в то время, в банке альянса ";
$LNG['prem27']				    	= "купить";
$LNG['prem28']				    	= "Сброс премиум аккаунт, восстановлены 0 антивещества";
$LNG['prem29']				    	= "Премиум моделируется битва ";
$LNG['prem30']				    	= "Позволяет имитировать бой рассматривает Академию ";
$LNG['prem31']				    	= "Стоимость составляет";
$LNG['prem32']				    	= "Купить моделирование";
$LNG['prem33']				    	= "в день";
...
$LNG['planetcloak_option_one'] = 'Activate Cloak for 1 Day - 7 Days Cooldown (25.000 dm)';
$LNG['planetcloak_option_two'] = 'Activate Cloak for 7 Days - 30 Days Cooldown (150.000 dm)';
...
Cost of activation is 75.000 dark matter';
...
$LNG['purchase_text_two']					= 'Showing only the most popular methods of payment, there are a total of more than 500 worldwide. Click "Other pay method" and wait until the lightbox opens to see all available';
//GOVERNORS
...
$LNG['planet_message_8']					= 'You need to wait 10 minutes before next teleportations';
...
$LNG['create_am_not']			= 'Insufficient AM!';
$LNG['create_am_buy']			= 'Buy for AM';
$LNG['create_dm']			= 'Create for DM';
$LNG['create_dm_not']			= 'Insufficient DM!';
