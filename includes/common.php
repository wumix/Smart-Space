...
$debugbar["messages"]->addMessage("DebugBar is working. ;)");

require 'includes/config_eloquent.php';
...
{	
	...
	if($USER['bana'] == 1) {
		ShowErrorPage::printError("Your account is being verified. You can not be attacked or attack until this moment.", false);
	}
