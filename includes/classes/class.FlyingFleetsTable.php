...
class FlyingFleetsTable
{
	...
	public function getEventData($fleetRow, $Status)
	{
		...
		$FleetContent   = $LNG['ov_fleet'].' '.$this->CreateFleetPopupedFleetLink($fleetRow, $FleetName, $FleetPrefix.$FleetStyle[$MissionType]);
		$FleetCapacity  = $LNG['type_mission'][$MissionType].' '.$this->CreateFleetPopupedMissionLink($fleetRow, $LNG['type_mission'][$MissionType], $FleetPrefix.$FleetStyle[$MissionType]);
