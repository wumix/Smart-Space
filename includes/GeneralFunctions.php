...
function exceptionHandler($exception) 
{
	...
	<head>
		...
		<link rel="apple-touch-startup-image" href="img/splash/iphone.png" media="screen and (max-device-width: 320px)">
				...
				<div class="row">
										...
										<div class="col-sm-12">
											<ul class="list-inline">
												...
												<li>
													&nbsp;<a href="source">Check Source Wiki</a>&nbsp;
												</li>
											</ul>
										</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center error-box">
									<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i>'.$errorType[$errno].'</h2>
									<br />
									<p class="lead">
										The space monkeys detected corrupted people on the crew<br>Maybe it is time to notify your moderator<b> copy-pasting the following error </b>
									</p>
									<br>
									<div class="well well-lg col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<p align=left>
													<b>Message: </b><br><font color="red">'.$exception->getMessage().'</font><br><br>
			<b>File: </b><br><font color="red">'.$exception->getFile().'</font><br><br>
			...
			<b>MySQL-Cleint-Version: </b>'.mysqli_get_client_info().'<br><br>
