...
class ShowMessagesPage extends AbstractPage
{
	...
	function show()
	{
		...
		$DeleteAllMessagesButton  = HTTP::_GP('action', '', UTF8_SUPPORT);
		
						if( $DeleteAllMessagesButton == 'delete'){	
$GLOBALS['DATABASE']->query("DELETE FROM uni1_messages WHERE message_owner= '".$USER['id']."';");
$this->printMessage('All messages deleted',  true, array('game.php?page=overview', 1)); 
exit; 
}
