...
{block name="content"}
	...
	<tr>
		<td colspan="2"><button type="submit" class="btn txt-color-white btn-block bg-color-teal btn-sm" name="answer" value="yes">{$LNG.al_acept_request}</button></td>
		<td colspan="2"><button type="submit" class="btn txt-color-white btn-block bg-color-teal btn-sm" name="answer" value="no">{$LNG.al_decline_request}</button></td>
	</tr>
	</tbody>
											</table>
											</form>
