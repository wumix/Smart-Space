...
<head>
	...
	<link rel="icon" href="styles/img/favicon/favicon.ico" type="image/x-icon">
...
<header id="header">
	...
	<span id="extr-page-header-space"> <a href="game.php" class="btn btn-danger">Turn Back To Game</a> </span>
	...
	<div id="content" class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
				<h1 class="txt-color-red login-header-big">SmartSpace</h1>
				<div class="hero">

					<div class="pull-left login-desc-box-l">
						<h4 class="paragraph-header">It's Okay to be Smart. Experience the simplicity of SmartSpace, everywhere you go!</h4>
						<div class="login-app-icons">
							<a href="https://kaliforge.com/" class="btn btn-danger btn-sm">Improve your host and website</a>
							<a href="https://kaliforge.com/" class="btn btn-danger btn-sm">Find out more of this...</a>
						</div>
					</div>

					<img src="styles/img/demo/iphoneview.png" class="pull-right display-image" alt="" style="width:210px">

				</div>

				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<h5 class="about-heading">About KaliForge - Are you up to date?</h5>
						<p>
							Hosting, VPS, dedicated server, website designs and so much more... Make sure that you check our <a href="https://kaliforge.com/">official website</a>.
						</p>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<h5 class="about-heading">SmartSpace Is Not Just a Design!</h5>
						<p>
							Every page we offer to our clients has been prepared one by one. We checked every detail to make our clients happy and satisfied.
						</p>
					</div>
				</div>
				...
				<div class="well no-padding">
					<form action="" method="post" id="login-form" class="smart-form client-form">
						...
						<fieldset>
							...
							<section>
								<label class="label">{$LNG.adm_username}</label>
							...
							<section>
								<label class="label">{$LNG.adm_password}</label>
...
<script> if (!window.jQuery) { document.write('<script src="styles/js/libs/jquery-2.1.1.min.js"><\/script>');} </script>

<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
<script> if (!window.jQuery.ui) { document.write('<script src="styles/js/libs/jquery-ui-1.10.3.min.js"><\/script>');} </script>
